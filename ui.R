                                      ...
                                      tabPanel("Non-linear Models (Developmental and Not-Published)",
                                               ...
                                               tabsetPanel(
                                                 tabPanel("Results (Printed)",
                                                        ...
                                                        textOutput("textnl1"),
                                                        tags$br(),
                                                        span(textOutput("textnl2i"), style = "font-weight: bold"),
                                                        span(tableOutput("textnl2"), style = "font-weight: normal"),
                                                        tags$br(),
                                                        span(textOutput("textnl3i"), style = "font-weight: bold"),
                                                        tableOutput("textnl3"),
                                                        tags$br(),
                                                        textOutput("textnl4"),
                                                        tags$br(),
